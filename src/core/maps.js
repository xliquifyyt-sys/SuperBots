...
export const MAPS = {
  ...
  nimbus: {
    ...
    pads: [{ x: 15, y: 17, to: [15.5, 5.0], label: 'Updraft vent' },      // floats over the bottom island, left -> top-left perch
           ...
           { x: 5, y: 20, to: [7, 13.5], label: 'Rescue vent' },          // under the left shelf: fall past it and get thrown back on top
           { x: 44, y: 20, to: [43, 13.5], label: 'Rescue vent' }],       // under the right shelf, same
